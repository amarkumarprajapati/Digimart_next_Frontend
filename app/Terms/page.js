      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-600">
            By accessing our website, you agree to be bound by these Terms & Conditions. If you do not agree, please do not use our services.
          </p>
        </section>
        <section className="mb-6">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-600">
            All content on this website is owned by YourCompany and protected by copyright laws.
          </p>
        </section>
        <section className="mb-6">
          <h2 className="text-2xl font-semibold text-gray-800 mb-2">4. Limitation of Liability</h2>
          <p className="text-gray-600">
            YourCompany is not liable for any damages arising from the use of our services.
          </p>
        </section>
      </main>
    </MainLayout>
