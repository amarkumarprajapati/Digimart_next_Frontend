...
const Popular = () => {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => productService.getPopularProducts(pageParam, 10),
    initialPageParam: 1,
  ...
  return (
    <section className="relative w-full py-16 bg-[#fdfdfd] dark:bg-slate-950 overflow-hidden">
      {/* Decorative Background Pattern */}
      <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none" style={{ backgroundImage: `radial-gradient(#088395 1px, transparent 1px)`, backgroundSize: '40px 40px' }} />
        ...
        <div className="mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg md:text-xl font-medium leading-relaxed">
              Discover the most loved pieces by our community. Curated for
              style, comfort, and premium quality.
            </p>
          </div>
